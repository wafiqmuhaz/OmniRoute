...
export const OAUTH_PROVIDERS = {
  ...
  freebuff: {
    ...
    riskNoticeVariant: "oauth",
    authHint:
      "Freebuff is a free, ad-supported coding assistant by Codebuff. Sign in via the device code flow to get an auth token, or paste an existing authToken. Catalog: DeepSeek V4 / GPT-5.6 Luna / MiMo / MiniMax M3 / Claude Fable / GLM / Kimi K3 / Muse Spark.",
  },
};
