...
// Freebuff (Codebuff) OAuth Configuration — Custom Device Code Flow
//
...
//   2. Poll https://freebuff.com/api/auth/cli/status until authenticated
//   3. Returns { authToken } which is used as Bearer token for API calls
//
